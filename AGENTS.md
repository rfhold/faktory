...
- Follow [the model-project contract](docs/architecture/model-projects-libraries.md) and [the object-store migration contract](docs/operations/object-store-migrations.md) for the approved multi-file cutover.
