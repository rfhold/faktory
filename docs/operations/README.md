...
These documents define MVP operation for repository implementations and declarations, including model-project migration and shared-library rollout recovery. They provide no evidence that a collector, bucket, route, pipeline, preview stack, or production stack exists live.
...
| [Object-store migrations](object-store-migrations.md) | Ordered migrations, legacy project conversion, artifact remapping, and rollback boundaries. |
